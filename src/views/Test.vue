      ...
      <div class="fade-up" v-else>
        <div v-if="cards.length">
          ...
          <transition name="card-slide-right" mode="out-in">
            <div v-if="end" key="1">
              <div class="card__header purple text-white pxy-custom text-center">
                <div v-if="resultPercent == 100">
                  ...
                  <h1 class="font-weight-lighter my-4">
                    Congratulations, you've learned everything
                  </h1>
                  <p class="font-weight-light my-4">Keep reviewing to make sure they stick</p>
                </div>
                <div v-else-if="resultPercent == 0">
                  ...
                  <h1 class="font-weight-lighter my-4">Unfortunately, you've learned nothing</h1>
                  <p class="font-weight-light my-4">Don't give up. Keep trying</p>
                </div>
                <div v-else>
                  ...
                  <h1 class="font-weight-lighter my-4">You have got {{ correctCount }} correct out of {{ cards.length }}</h1>
                  <p class="font-weight-light my-4">Don't give up. Keep trying</p>
                </div>
                <button type="button" 
                  class="btn transparent-dark text-white"
                  v-shortkey="['space']" 
                  @shortkey="shuffle" 
                  @click="shuffle"
                  >Start over</button>
              ...
              <div class="card__footer text-center">
                <p class="text-muted font-weight-light mb-0">Keep reviewing and trying your most missed terms to make sure they stick</p>
              </div>
            </div>
            <div v-else-if="result" key="2">
              <div class="card__header pxy-custom text-center purple">
                <div v-if="correct">
                  ...
                  <h1 class="font-weight-lighter text-white mt-4">You are doing great</h1>
                  <p class="font-weight-light text-white mb-4">Well done. That's the right answer</p>
                </div>
                <div v-else>
                  <svg width="64" height="64" viewBox="0 0 64 64">
                    <circle fill="#FDCA47" cx="32" cy="32" r="30"></circle><path fill="#F9B700" d="M51.654 9.346A29.869 29.869 0 0 1 59 29c0 16.569-13.432 30-30 30a29.871 29.871 0 0 1-19.654-7.345C14.846 57.99 22.952 62 32 62c16.568 0 30-13.431 30-30 0-9.047-4.012-17.152-10.346-22.654z"></path><path fill-rule="evenodd" clip-rule="evenodd" fill="#FFE8BB" d="M6.418 20.5C5.302 24.242 13 11 25 6.084c5.834-2.391-13.832-1.5-18.582 14.416z"></path><circle fill="#302C3B" cx="42.387" cy="24.677" r="4.999"></circle><path fill="#302C3B" d="M18.867 23.748a5 5 0 1 0 1.735 9.849 5 5 0 0 0-1.735-9.849zm25.389 17.236c-6.754-1.632-16.871-.215-21.526 6.138-.834 1.137-.022 2.335 1.144 1.559 4.455-2.965 13.092-4.799 19.311-3.322 2.375.564 3.557-3.748 1.071-4.375z"></path>
                  </svg>
                  <h1 class="font-weight-lighter text-white mt-4">Study this one</h1>
                  <p class="font-weight-light mb-4 text-white">Unfortunately. Your answer is incorrect</p>
                </div>
                <button type="button" 
                  class="btn transparent-dark text-white"
                  v-shortkey="['space']" 
              ...
              <div class="card__footer text-center">
                <div class="white-space">
                  <h1 class="font-weight-lighter" v-html="formatText(cards[cardIdx].definition)"></h1>
                </div>
                <p class="text-muted my-4 font-weight-light">goes with</p>
                <h1 class="font-weight-lighter">{{ cards[cardIdx].term }}</h1>
              </div>
            </div>
            <div key="3" v-else>
              <div class="text-center mb-custom">
                <span class="circle circle-md purple text-white">
                  {{ cardIdx+1 }}
                </span>
              </div>
              <div class="default-card text-center white-space">
                <h1 class="font-weight-lighter mb-0"  
              ...
              <div class="default-card answer-list"
                ...
                <div class="row">
                  ...
                  <div class="col align-self-center">
                    <h1 class="font-weight-lighter mb-0">{{ answer.term }}</h1>
                  </div>
                </div>
              </div>
            </div>
