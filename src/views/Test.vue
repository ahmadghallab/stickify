        ...
        <div v-if="cards.length">
          ...
          <transition name="card-slide" mode="out-in">
            ...
            <div v-else-if="result" key="2">
              <div class="card__header text-white pxy-custom text-center purple">
                <div v-if="correct">
                ...
                <div v-else>
                  ...
                  <p class="mb-4">Unfortunately. Your answer is incorrect</p>
                </div>
                <button type="button" 
                  class="btn transparent-dark text-white"
                  v-shortkey="['space']" 
    ...
    getAnswers () {
      if (!this.end) {
        ...
        for (let i = this.cards.length - 1; i > 0; i--) {
          ...
          if (!prevRandIdx.includes(randomCardIndex) && this.cards[randomCardIndex].term != this.cards[this.cardIdx].term) {
            this.answers.push(this.cards[randomCardIndex])
          }
          if (this.answers.length == 3) break
          prevRandIdx.push(randomCardIndex)
        }
