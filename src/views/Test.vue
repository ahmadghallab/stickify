            ...
            <div v-if="end" key="1">
              <div class="card__header purple text-white pxy-custom text-center">
                <div v-if="resultPercent == 100">
                  ...
                  <h4 class="font-weight-lighter my-4">
                ...
                <div v-else-if="resultPercent == 0">
                  ...
                  <h4 class="font-weight-bold my-4">Unfortunately, you've learned nothing</h4>
                ...
                <div v-else>
                  ...
                  <h4 class="font-weight-bold my-4">You have got {{ correctCount }} correct out of {{ cards.length }}</h4>
                  <p class="font-weight-light my-4">Don't give up. Keep trying</p>
                </div>
                <button type="button" 
            ...
            <div v-else-if="result" key="2">
              <div class="card__header pxy-custom text-center purple">
                <div v-if="correct">
                  ...
                  <h4 class="font-weight-bold text-white mt-4">You are doing great</h4>
                ...
                <div v-else>
                  ...
                  <h4 class="font-weight-bold text-white mt-4">Study this one</h4>
              ...
              <div class="card__footer text-center">
                <div class="white-space">
                  <h4 v-html="formatText(cards[cardIdx].definition)"></h4>
                </div>
                <p class="text-muted my-4 font-weight-light">goes with</p>
                <h4 class="font-weight-bold">{{ cards[cardIdx].term }}</h4>
              </div>
            </div>
            <div key="3" v-else>
              ...
              <div class="default-card answer-list"
                ...
                <div class="row">
                  ...
                  <div class="col align-self-center">
                    <h4 class="font-weight-bold mb-0">{{ answer.term }}</h4>
                  </div>
                </div>
              </div>
            </div>
