<template>
  <div>
    ...
    <div class="card-deck fade-up" v-else>
      ...
      <div class="card studyset" v-for="(studyset, idx) in studysets"   
        v-bind:key="idx">
        <div class="card-body">
        ...
        <div class="card-footer border-top-0 bg-white">
              ...
              <div class="card__footer">
                <form v-on:submit.prevent="updateStudySet(idx)">
                  <div class="form-row">
                    ...
                    <div class="form-group col-12">
                      <input type="hidden" v-model="studyset.is_public">
                      <a href="javascript:void(0)" 
                        class="badge badge-pill grey mr-1 text-white"
                        v-bind:class="{'green': studyset.is_public}"
                        @click="updatePublicPrivate(idx)">public</a>
                      <a href="javascript:void(0)" 
          ...
          <a href="javascript:void(0)" 
            class="badge badge-pill grey ml-1 text-white"
            @click="deleteStudySetConfirmModal(studyset.id)">delete</a>
...
export default {
  ...
  methods: {
    ...
    updatePublicPrivate(index) {
      this.studysets[index].is_public = !this.studysets[index].is_public
    },
    listUserStudySets () {
    ...
    updateStudySet(index) {
      ...
      appService.updateStudySet({
        ...
        is_public: this.studysets[index].is_public
      }).then(() => {
